...
#(
  ...
  parameter p_mem_sz  = 128, // size of physical memory in bytes
  ...
  wire [c_resp_msg_sz-1:0] bypqresp2_msg;
  wire [c_resp_msg_sz-1:0] bypqresp3_msg;
  ...
  //assign memresp2_msg = bypqresp2_msg;
  //assign memresp2_val = memreq2_val_M;
  //assign memreq2_rdy  = memresp2_rdy;

  //assign memresp3_msg = bypqresp3_msg;
  ...
  (
    .clk      (clk),
    .reset    (reset),
    .enq_bits (bypqresp2_msg), // wire up to MsgToBits output
  ...
  (
    .clk      (clk),
    .reset    (reset),
    .enq_bits (bypqresp3_msg), // wire up to MsgToBits output
