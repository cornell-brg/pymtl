...
def test_queue_3( dump_vcd ):
  run_test_queue( dump_vcd, NormalQueue, 3, [
    ...
    [ 1,      1,      0x0005,  1,      0,      0x0002 ],
    [ 1,      1,      0x0006,  1,      0,      0x0002 ],
    [ 1,      1,      0x0007,  1,      0,      0x0002 ],
    [ 1,      1,      0x0008,  1,      0,      0x0002 ],
    [ 1,      1,      0x0009,  1,      0,      0x0002 ],
    [ 1,      0,      0x0010,  1,      0,      0x0002 ],
    [ 1,      0,      0x0005,  1,      1,      0x0002 ],
    [ 0,      1,      0x0005,  1,      1,      0x0003 ],
    [ 0,      1,      0x0005,  1,      1,      0x0004 ],
    [ 0,      1,      0x0005,  1,      1,      0x0005 ],
    [ 0,      1,      0x0005,  1,      1,      0x0006 ],
    [ 0,      1,      0x0005,  1,      1,      0x0007 ],
    [ 0,      1,      0x0005,  1,      1,      0x0008 ],
    [ 0,      1,      0x0005,  1,      1,      0x0009 ],
    [ 0,      1,      0x0005,  0,      1,      '?'    ],
  ])
