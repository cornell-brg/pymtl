...
def run_proc_test( ModelType, test_verilog, dump_vcd, input_list ):
...
#-----------------------------------------------------------------------
def run_bypass_proc_test( dump_vcd, test_verilog, input_list ):
  run_proc_test( Tile, test_verilog, dump_vcd, input_list )
...
def test_mtc2_1x1_delay0( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, [0]+mtc2_1x1() )
@requires_xcc
def test_mtc2_1x1_delay5( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, [5]+mtc2_1x1() )
...
def test_mtc2_3x3_delay0( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, [0]+mtc2_3x3() )
@requires_xcc
def test_mtc2_3x3_delay5( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, [5]+mtc2_3x3() )
...
def test_j_after_ld_stall( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, [0]+j_after_ld_stall() )
...
def test_mul_scoreboard_clear_bug( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, [0]+mul_scoreboard_clear_bug() )
...
def test_bypass_direct_from_X( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, bypass_from_X() )
...
def test_bypass_addiu_no_hazards( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, addiu_no_hazards() )

@requires_xcc
def test_bypass_addiu_hazard_W( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, addiu_hazard_W() )

@requires_xcc
def test_bypass_addiu_hazard_M( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, addiu_hazard_M() )

@requires_xcc
def test_bypass_addiu_hazard_X( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, addiu_hazard_X() )

@requires_vmh
def test_bypass_addiu_vmh_delay0( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, addiu_vmh_delay0() )

@requires_vmh
def test_bypass_addiu_vmh_delay5( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, addiu_vmh_delay5() )
...
def test_bypass_ori_no_hazards( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, ori_no_hazards() )

@requires_xcc
def test_bypass_ori_hazard_W( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, ori_hazard_W() )

@requires_xcc
def test_bypass_ori_hazard_M( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, ori_hazard_M() )

@requires_xcc
def test_bypass_ori_hazard_X( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, ori_hazard_X() )

@requires_vmh
def test_bypass_ori_vmh_delay0( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, ori_vmh_delay0() )

@requires_vmh
def test_bypass_ori_vmh_delay5( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, ori_vmh_delay5() )
...
def test_bypass_lui_no_hazards( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, lui_no_hazards() )

@requires_xcc
def test_bypass_lui_hazard_W( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, lui_hazard_W() )

@requires_xcc
def test_bypass_lui_hazard_M( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, lui_hazard_M() )

@requires_xcc
def test_bypass_lui_hazard_X( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, lui_hazard_X() )

@requires_vmh
def test_bypass_lui_vmh_delay0( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, lui_vmh_delay0() )

@requires_vmh
def test_bypass_lui_vmh_delay5( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, lui_vmh_delay5() )
...
def test_bypass_addu_no_hazards( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, addu_no_hazards() )

@requires_xcc
def test_bypass_addu_hazard_W( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, addu_hazard_W() )

@requires_xcc
def test_bypass_addu_hazard_M( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, addu_hazard_M() )

@requires_xcc
def test_bypass_addu_hazard_X( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, addu_hazard_X() )

@requires_vmh
def test_bypass_addu_vmh_delay0( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, addu_vmh_delay0() )

@requires_vmh
def test_bypass_addu_vmh_delay5( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, addu_vmh_delay5() )
...
def test_bypass_lw_no_hazards( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, lw_no_hazards() )

@requires_xcc
def test_bypass_lw_hazard_W( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, lw_hazard_W() )

@requires_xcc
def test_bypass_lw_hazard_M( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, lw_hazard_M() )

@requires_xcc
def test_bypass_lw_hazard_X( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, lw_hazard_X() )

@requires_vmh
def test_bypass_lw_vmh_delay0( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, lw_vmh_delay0() )

@requires_vmh
def test_bypass_lw_vmh_delay5( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, lw_vmh_delay5() )
...
def test_bypass_sw_no_hazards( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, sw_no_hazards() )

@requires_xcc
def test_bypass_sw_hazard_W( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, sw_hazard_W() )

@requires_xcc
def test_bypass_sw_hazard_M( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, sw_hazard_M() )

@requires_xcc
def test_bypass_sw_hazard_X( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, sw_hazard_X() )

@requires_vmh
def test_bypass_sw_vmh_delay0( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, sw_vmh_delay0() )

@requires_vmh
def test_bypass_sw_vmh_delay5( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, sw_vmh_delay5() )
...
def test_bypass_jal_asm( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, jal_asm() )

@requires_vmh
def test_bypass_jal_vmh_delay0( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, jal_vmh_delay0() )

@requires_vmh
def test_bypass_jal_vmh_delay5( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, jal_vmh_delay5() )
...
def test_bypass_jr_asm( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, jr_asm() )

@requires_vmh
def test_bypass_jr_vmh_delay0( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, jr_vmh_delay0() )

@requires_vmh
def test_bypass_jr_vmh_delay5( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, jr_vmh_delay5() )
...
def test_bypass_bne_asm( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, bne_asm() )

@requires_vmh
def test_bypass_bne_vmh_delay0( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, bne_vmh_delay0() )

@requires_vmh
def test_bypass_bne_vmh_delay5( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, bne_vmh_delay5() )
...
def test_bypass_andi_no_hazards( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, andi_no_hazards() )

@requires_xcc
def test_bypass_andi_hazard_W( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, andi_hazard_W() )

@requires_xcc
def test_bypass_andi_hazard_M( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, andi_hazard_M() )

@requires_xcc
def test_bypass_andi_hazard_X( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, andi_hazard_X() )

@requires_vmh
def test_bypass_andi_vmh_delay0( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, andi_vmh_delay0() )

@requires_vmh
def test_bypass_andi_vmh_delay5( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, andi_vmh_delay5() )
...
def test_bypass_xori_no_hazards( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, xori_no_hazards() )

@requires_xcc
def test_bypass_xori_hazard_W( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, xori_hazard_W() )

@requires_xcc
def test_bypass_xori_hazard_M( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, xori_hazard_M() )

@requires_xcc
def test_bypass_xori_hazard_X( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, xori_hazard_X() )

@requires_vmh
def test_bypass_xori_vmh_delay0( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, xori_vmh_delay0() )

@requires_vmh
def test_bypass_xori_vmh_delay5( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, xori_vmh_delay5() )
...
def test_bypass_slti_no_hazards( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, slti_no_hazards() )

@requires_xcc
def test_bypass_slti_hazard_W( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, slti_hazard_W() )

@requires_xcc
def test_bypass_slti_hazard_M( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, slti_hazard_M() )

@requires_xcc
def test_bypass_slti_hazard_X( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, slti_hazard_X() )

@requires_vmh
def test_bypass_slti_vmh_delay0( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, slti_vmh_delay0() )

@requires_vmh
def test_bypass_slti_vmh_delay5( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, slti_vmh_delay5() )
...
def test_bypass_sltiu_no_hazards( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, sltiu_no_hazards() )

@requires_xcc
def test_bypass_sltiu_hazard_W( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, sltiu_hazard_W() )

@requires_xcc
def test_bypass_sltiu_hazard_M( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, sltiu_hazard_M() )

@requires_xcc
def test_bypass_sltiu_hazard_X( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, sltiu_hazard_X() )

@requires_vmh
def test_bypass_sltiu_vmh_delay0( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, sltiu_vmh_delay0() )

@requires_vmh
def test_bypass_sltiu_vmh_delay5( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, sltiu_vmh_delay5() )
...
def test_bypass_sll_no_hazards( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, sll_no_hazards() )

@requires_xcc
def test_bypass_sll_hazard_W( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, sll_hazard_W() )

@requires_xcc
def test_bypass_sll_hazard_M( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, sll_hazard_M() )

@requires_xcc
def test_bypass_sll_hazard_X( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, sll_hazard_X() )

@requires_vmh
def test_bypass_sll_vmh_delay0( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, sll_vmh_delay0() )

@requires_vmh
def test_bypass_sll_vmh_delay5( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, sll_vmh_delay5() )
...
def test_bypass_srl_no_hazards( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, srl_no_hazards() )

@requires_xcc
def test_bypass_srl_hazard_W( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, srl_hazard_W() )

@requires_xcc
def test_bypass_srl_hazard_M( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, srl_hazard_M() )

@requires_xcc
def test_bypass_srl_hazard_X( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, srl_hazard_X() )

@requires_vmh
def test_bypass_srl_vmh_delay0( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, srl_vmh_delay0() )

@requires_vmh
def test_bypass_srl_vmh_delay5( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, srl_vmh_delay5() )
...
def test_bypass_sra_no_hazards( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, sra_no_hazards() )

@requires_xcc
def test_bypass_sra_hazard_W( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, sra_hazard_W() )

@requires_xcc
def test_bypass_sra_hazard_M( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, sra_hazard_M() )

@requires_xcc
def test_bypass_sra_hazard_X( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, sra_hazard_X() )

@requires_vmh
def test_bypass_sra_vmh_delay0( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, sra_vmh_delay0() )

@requires_vmh
def test_bypass_sra_vmh_delay5( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, sra_vmh_delay5() )
...
def test_bypass_sllv_no_hazards( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, sllv_no_hazards() )

@requires_xcc
def test_bypass_sllv_hazard_W( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, sllv_hazard_W() )

@requires_xcc
def test_bypass_sllv_hazard_M( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, sllv_hazard_M() )

@requires_xcc
def test_bypass_sllv_hazard_X( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, sllv_hazard_X() )

@requires_vmh
def test_bypass_sllv_vmh_delay0( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, sllv_vmh_delay0() )

@requires_vmh
def test_bypass_sllv_vmh_delay5( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, sllv_vmh_delay5() )
...
def test_bypass_srlv_no_hazards( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, srlv_no_hazards() )

@requires_xcc
def test_bypass_srlv_hazard_W( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, srlv_hazard_W() )

@requires_xcc
def test_bypass_srlv_hazard_M( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, srlv_hazard_M() )

@requires_xcc
def test_bypass_srlv_hazard_X( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, srlv_hazard_X() )

@requires_vmh
def test_bypass_srlv_vmh_delay0( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, srlv_vmh_delay0() )

@requires_vmh
def test_bypass_srlv_vmh_delay5( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, srlv_vmh_delay5() )
...
def test_bypass_srav_no_hazards( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, srav_no_hazards() )

@requires_xcc
def test_bypass_srav_hazard_W( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, srav_hazard_W() )

@requires_xcc
def test_bypass_srav_hazard_M( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, srav_hazard_M() )

@requires_xcc
def test_bypass_srav_hazard_X( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, srav_hazard_X() )

@requires_vmh
def test_bypass_srav_vmh_delay0( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, srav_vmh_delay0() )

@requires_vmh
def test_bypass_srav_vmh_delay5( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, srav_vmh_delay5() )
...
def test_bypass_subu_no_hazards( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, subu_no_hazards() )

@requires_xcc
def test_bypass_subu_hazard_W( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, subu_hazard_W() )

@requires_xcc
def test_bypass_subu_hazard_M( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, subu_hazard_M() )

@requires_xcc
def test_bypass_subu_hazard_X( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, subu_hazard_X() )

@requires_vmh
def test_bypass_subu_vmh_delay0( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, subu_vmh_delay0() )

@requires_vmh
def test_bypass_subu_vmh_delay5( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, subu_vmh_delay5() )
...
def test_bypass_and_no_hazards( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, and_no_hazards() )

@requires_xcc
def test_bypass_and_hazard_W( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, and_hazard_W() )

@requires_xcc
def test_bypass_and_hazard_M( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, and_hazard_M() )

@requires_xcc
def test_bypass_and_hazard_X( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, and_hazard_X() )

@requires_vmh
def test_bypass_and_vmh_delay0( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, and_vmh_delay0() )

@requires_vmh
def test_bypass_and_vmh_delay5( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, and_vmh_delay5() )
...
def test_bypass_or_no_hazards( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, or_no_hazards() )

@requires_xcc
def test_bypass_or_hazard_W( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, or_hazard_W() )

@requires_xcc
def test_bypass_or_hazard_M( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, or_hazard_M() )

@requires_xcc
def test_bypass_or_hazard_X( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, or_hazard_X() )

@requires_vmh
def test_bypass_or_vmh_delay0( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, or_vmh_delay0() )

@requires_vmh
def test_bypass_or_vmh_delay5( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, or_vmh_delay5() )
...
def test_bypass_xor_no_hazards( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, xor_no_hazards() )

@requires_xcc
def test_bypass_xor_hazard_W( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, xor_hazard_W() )

@requires_xcc
def test_bypass_xor_hazard_M( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, xor_hazard_M() )

@requires_xcc
def test_bypass_xor_hazard_X( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, xor_hazard_X() )

@requires_vmh
def test_bypass_xor_vmh_delay0( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, xor_vmh_delay0() )

@requires_vmh
def test_bypass_xor_vmh_delay5( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, xor_vmh_delay5() )
...
def test_bypass_nor_no_hazards( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, nor_no_hazards() )

@requires_xcc
def test_bypass_nor_hazard_W( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, nor_hazard_W() )

@requires_xcc
def test_bypass_nor_hazard_M( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, nor_hazard_M() )

@requires_xcc
def test_bypass_nor_hazard_X( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, nor_hazard_X() )

@requires_vmh
def test_bypass_nor_vmh_delay0( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, nor_vmh_delay0() )

@requires_vmh
def test_bypass_nor_vmh_delay5( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, nor_vmh_delay5() )
...
def test_bypass_slt_no_hazards( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, slt_no_hazards() )

@requires_xcc
def test_bypass_slt_hazard_W( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, slt_hazard_W() )

@requires_xcc
def test_bypass_slt_hazard_M( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, slt_hazard_M() )

@requires_xcc
def test_bypass_slt_hazard_X( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, slt_hazard_X() )

@requires_vmh
def test_bypass_slt_vmh_delay0( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, slt_vmh_delay0() )

@requires_vmh
def test_bypass_slt_vmh_delay5( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, slt_vmh_delay5() )
...
def test_bypass_sltu_no_hazards( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, sltu_no_hazards() )

@requires_xcc
def test_bypass_sltu_hazard_W( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, sltu_hazard_W() )

@requires_xcc
def test_bypass_sltu_hazard_M( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, sltu_hazard_M() )

@requires_xcc
def test_bypass_sltu_hazard_X( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, sltu_hazard_X() )

@requires_vmh
def test_bypass_sltu_vmh_delay0( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, sltu_vmh_delay0() )

@requires_vmh
def test_bypass_sltu_vmh_delay5( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, sltu_vmh_delay5() )
...
def test_bypass_mul_no_hazards( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, mul_no_hazards() )

@requires_xcc
def test_bypass_mul_hazard_W( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, mul_hazard_W() )

@requires_xcc
def test_bypass_mul_hazard_M( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, mul_hazard_M() )

@requires_xcc
def test_bypass_mul_hazard_X( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, mul_hazard_X() )

@requires_vmh
def test_bypass_mul_vmh_delay0( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, mul_vmh_delay0() )

@requires_vmh
def test_bypass_mul_vmh_delay5( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, mul_vmh_delay5() )
...
def test_bypass_div_no_hazards( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, div_no_hazards() )

@requires_xcc
def test_bypass_div_hazard_W( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, div_hazard_W() )

@requires_xcc
def test_bypass_div_hazard_M( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, div_hazard_M() )

@requires_xcc
def test_bypass_div_hazard_X( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, div_hazard_X() )

@requires_vmh
def test_bypass_div_vmh_delay0( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, div_vmh_delay0() )

@requires_vmh
def test_bypass_div_vmh_delay5( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, div_vmh_delay5() )
...
def test_bypass_divu_no_hazards( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, divu_no_hazards() )

@requires_xcc
def test_bypass_divu_hazard_W( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, divu_hazard_W() )

@requires_xcc
def test_bypass_divu_hazard_M( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, divu_hazard_M() )

@requires_xcc
def test_bypass_divu_hazard_X( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, divu_hazard_X() )

@requires_vmh
def test_bypass_divu_vmh_delay0( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, divu_vmh_delay0() )

@requires_vmh
def test_bypass_divu_vmh_delay5( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, divu_vmh_delay5() )
...
def test_bypass_rem_no_hazards( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, rem_no_hazards() )

@requires_xcc
def test_bypass_rem_hazard_W( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, rem_hazard_W() )

@requires_xcc
def test_bypass_rem_hazard_M( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, rem_hazard_M() )

@requires_xcc
def test_bypass_rem_hazard_X( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, rem_hazard_X() )

@requires_vmh
def test_bypass_rem_vmh_delay0( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, rem_vmh_delay0() )

@requires_vmh
def test_bypass_rem_vmh_delay5( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, rem_vmh_delay5() )
...
def test_bypass_remu_no_hazards( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, remu_no_hazards() )

@requires_xcc
def test_bypass_remu_hazard_W( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, remu_hazard_W() )

@requires_xcc
def test_bypass_remu_hazard_M( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, remu_hazard_M() )

@requires_xcc
def test_bypass_remu_hazard_X( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, remu_hazard_X() )

@requires_vmh
def test_bypass_remu_vmh_delay0( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, remu_vmh_delay0() )

@requires_vmh
def test_bypass_remu_vmh_delay5( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, remu_vmh_delay5() )
...
def test_bypass_lb_no_hazards( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, lb_no_hazards() )

@requires_xcc
def test_bypass_lb_hazard_W( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, lb_hazard_W() )

@requires_xcc
def test_bypass_lb_hazard_M( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, lb_hazard_M() )

@requires_xcc
def test_bypass_lb_hazard_X( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, lb_hazard_X() )

@requires_vmh
def test_bypass_lb_vmh_delay0( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, lb_vmh_delay0() )

@requires_vmh
def test_bypass_lb_vmh_delay5( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, lb_vmh_delay5() )
...
def test_bypass_lbu_no_hazards( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, lbu_no_hazards() )

@requires_xcc
def test_bypass_lbu_hazard_W( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, lbu_hazard_W() )

@requires_xcc
def test_bypass_lbu_hazard_M( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, lbu_hazard_M() )

@requires_xcc
def test_bypass_lbu_hazard_X( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, lbu_hazard_X() )

@requires_vmh
def test_bypass_lbu_vmh_delay0( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, lbu_vmh_delay0() )

@requires_vmh
def test_bypass_lbu_vmh_delay5( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, lbu_vmh_delay5() )
...
def test_bypass_lh_no_hazards( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, lh_no_hazards() )

@requires_xcc
def test_bypass_lh_hazard_W( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, lh_hazard_W() )

@requires_xcc
def test_bypass_lh_hazard_M( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, lh_hazard_M() )

@requires_xcc
def test_bypass_lh_hazard_X( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, lh_hazard_X() )

@requires_vmh
def test_bypass_lh_vmh_delay0( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, lh_vmh_delay0() )

@requires_vmh
def test_bypass_lh_vmh_delay5( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, lh_vmh_delay5() )
...
def test_bypass_lhu_no_hazards( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, lhu_no_hazards() )

@requires_xcc
def test_bypass_lhu_hazard_W( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, lhu_hazard_W() )

@requires_xcc
def test_bypass_lhu_hazard_M( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, lhu_hazard_M() )

@requires_xcc
def test_bypass_lhu_hazard_X( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, lhu_hazard_X() )

@requires_vmh
def test_bypass_lhu_vmh_delay0( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, lhu_vmh_delay0() )

@requires_vmh
def test_bypass_lhu_vmh_delay5( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, lhu_vmh_delay5() )
...
def test_bypass_sb_no_hazards( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, sb_no_hazards() )

@requires_xcc
def test_bypass_sb_hazard_W( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, sb_hazard_W() )

@requires_xcc
def test_bypass_sb_hazard_M( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, sb_hazard_M() )

@requires_xcc
def test_bypass_sb_hazard_X( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, sb_hazard_X() )

@requires_vmh
def test_bypass_sb_vmh_delay0( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, sb_vmh_delay0() )

@requires_vmh
def test_bypass_sb_vmh_delay5( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, sb_vmh_delay5() )
...
def test_bypass_sh_no_hazards( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, sh_no_hazards() )

@requires_xcc
def test_bypass_sh_hazard_W( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, sh_hazard_W() )

@requires_xcc
def test_bypass_sh_hazard_M( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, sh_hazard_M() )

@requires_xcc
def test_bypass_sh_hazard_X( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, sh_hazard_X() )

@requires_vmh
def test_bypass_sh_vmh_delay0( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, sh_vmh_delay0() )

@requires_vmh
def test_bypass_sh_vmh_delay5( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, sh_vmh_delay5() )
...
def test_bypass_j_asm( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, j_asm() )

@requires_vmh
@requires_xcc
def test_bypass_j_vmh_delay0( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, j_vmh_delay0() )

@requires_vmh
@requires_xcc
def test_bypass_j_vmh_delay5( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, j_vmh_delay5() )
...
def test_bypass_jalr_asm( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, jalr_asm() )

@requires_vmh
def test_bypass_jalr_vmh_delay0( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, jalr_vmh_delay0() )

@requires_vmh
def test_bypass_jalr_vmh_delay5( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, jalr_vmh_delay5() )
...
def test_bypass_beq_asm( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, beq_asm() )

@requires_vmh
def test_bypass_beq_vmh_delay0( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, beq_vmh_delay0() )

@requires_vmh
def test_bypass_beq_vmh_delay5( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, beq_vmh_delay5() )
...
def test_bypass_blez_asm( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, blez_asm() )

@requires_vmh
def test_bypass_blez_vmh_delay0( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, blez_vmh_delay0() )

@requires_vmh
def test_bypass_blez_vmh_delay5( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, blez_vmh_delay5() )
...
def test_bypass_bgtz_asm( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, bgtz_asm() )

@requires_vmh
def test_bypass_bgtz_vmh_delay0( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, bgtz_vmh_delay0() )

@requires_vmh
def test_bypass_bgtz_vmh_delay5( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, bgtz_vmh_delay5() )
...
def test_bypass_bltz_asm( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, bltz_asm() )

@requires_vmh
def test_bypass_bltz_vmh_delay0( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, bltz_vmh_delay0() )

@requires_vmh
def test_bypass_bltz_vmh_delay5( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, bltz_vmh_delay5() )
...
def test_bypass_bgez_asm( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, bgez_asm() )

@requires_vmh
def test_bypass_bgez_vmh_delay0( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, bgez_vmh_delay0() )

@requires_vmh
def test_bypass_bgez_vmh_delay5( dump_vcd, test_verilog ):
  run_bypass_proc_test( dump_vcd, test_verilog, bgez_vmh_delay5() )
