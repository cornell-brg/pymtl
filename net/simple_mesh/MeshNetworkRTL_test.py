...
def test_mesh( dump_vcd, test_verilog, src_delay, sink_delay, test_msgs ):
  run_net_test( dump_vcd, MeshNetworkRTL, src_delay, sink_delay, test_msgs,
