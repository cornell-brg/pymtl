...
def test_single_element_normal_queue_tv( dump_vcd ):
  ...
  model = get_verilated( SingleElementNormalQueue( 16 ) )
  model.elaborate()
...
def test_single_element_bypass_queue_tv( dump_vcd ):
  ...
  model = get_verilated( SingleElementBypassQueue( 16 ) )
  model.elaborate()
...
def run_test_queue( dump_vcd, ModelType, num_entries, test_vectors ):
  ...
  model = get_verilated( ModelType( num_entries, 16 ) )
  model.elaborate()
...
def test_single_element_pipe_queue_tv( dump_vcd ):
  ...
  model = get_verilated( SingleElementPipelinedQueue( 16 ) )
  model.elaborate()
