...
def test_routecompute( dump_vcd ):
  ...
  model = get_verilated( RouteCompute( router_x_id, router_y_id, num_routers, netmsg_params ) )
  #model = get_verilated( RouteCompute( router_x_id, router_y_id, num_routers, num_messages, payload_nbits))
  print model
