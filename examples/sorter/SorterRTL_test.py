...
def test_basics( dump_vcd ):
  run_sorter_test( dump_vcd, SorterRTL, test_vectors_basics )
...
def test_duplicates( dump_vcd ):
  run_sorter_test( dump_vcd, SorterRTL, test_vectors_duplicates )
...
def test_random( dump_vcd ):
  run_sorter_test( dump_vcd, SorterRTL, test_vectors_random )
