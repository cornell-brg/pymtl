...
def run_test_mux( dump_vcd, ModelType, num_inputs, test_vectors ):
  ...
  sel_nbits = clog2( num_inputs )
  model = ModelType( 16, sel_nbits )
  model.elaborate()
