...
`define VC_MEM_RESP_MSG_TYPE_SZ( p_data_sz ) 3
`define VC_MEM_RESP_MSG_TYPE_READ            3'd0
`define VC_MEM_RESP_MSG_TYPE_WRITE           3'd1
`define VC_MEM_RESP_MSG_TYPE_AMOADD          3'd2
`define VC_MEM_RESP_MSG_TYPE_AMOAND          3'd3
`define VC_MEM_RESP_MSG_TYPE_AMOOR           3'd4
`define VC_MEM_RESP_MSG_TYPE_AMOXCH          3'd5
