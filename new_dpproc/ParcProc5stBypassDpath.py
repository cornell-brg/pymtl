...
#-------------------------------------------------------------------------
# ParcProc5stBypassDpath
#-------------------------------------------------------------------------

class ParcProc5stBypassDpath( Model ):
  ...
  def elaborate_logic( s ):
    ...
    @s.combinational
    def cp2_go():
      s.cp2_go_D.value = s.to_cp2_msg[32:37] == 0 and s.to_cp2_msg[ 0:32] == 1
    ...
    s.connect( s.res_reg_W.out, s.op_byp_W      )
