...
from ParcProc5stBypassCtrl  import ParcProc5stBypassCtrl
from ParcProc5stBypassDpath import ParcProc5stBypassDpath

#-------------------------------------------------------------------------
# parc processor 5 stage stalling pipeline
#-------------------------------------------------------------------------

class ParcProc5stBypass( Model ):
  ...
  def elaborate_logic( s ):
    ...
    s.ctrl  = ParcProc5stBypassCtrl  ( )
    s.dpath = ParcProc5stBypassDpath ( reset_vector = s.reset_vector )
    ...
    s.connect( s.ctrl.from_cp2,     s.from_cp2     )
