...
def run_bypass_proc_test( dump_vcd, test_verilog, vcd_file_name, input_list ):
  run_proc_test( ParcProcPipelinedMul, test_verilog,
...
#---------------------------------------------------------------------------
import pytest
from   parcv2_mul_pipelined import *
@pytest.mark.parametrize( "asm_test", [
  mul_pipeline_addi_raw,
  mul_pipeline_add_raw,
  mul_pipeline_addi_waw,
...
from bypass_direct_test import bypass_from_X
