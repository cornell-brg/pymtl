...
from IntMulDivRTL           import IntMulDivRTL
...
# run_imuldiv_test
#-----------------------------------------------------------------------
def run_imuldiv_test( dump_vcd, vcd_file_name, model,
...
def test_mul_small_pp( dump_vcd, test_verilog ):
  model = IntMulDivRTL()
  if test_verilog:
    model = get_verilated( model )
  run_imuldiv_test( dump_vcd, "pex-imul-IntMulDivRTL_test_small_pp.vcd",
                    model, 0, 0, mul_test_msgs_small_pp )
...
def test_mul_small_np( dump_vcd, test_verilog ):
  model = IntMulDivRTL()
  if test_verilog:
    model = get_verilated( model )
  run_imuldiv_test( dump_vcd, "pex-imul-IntMulDivRTL_test_small_np.vcd",
                    model, 0, 0, mul_test_msgs_small_np )
...
def test_mul_small_pn( dump_vcd, test_verilog ):
  model = IntMulDivRTL()
  if test_verilog:
    model = get_verilated( model )
  run_imuldiv_test( dump_vcd, "pex-imul-IntMulDivRTL_test_small_pn.vcd",
                    model, 0, 0, mul_test_msgs_small_pn )
...
def test_mul_small_nn( dump_vcd, test_verilog ):
  model = IntMulDivRTL()
  if test_verilog:
    model = get_verilated( model )
  run_imuldiv_test( dump_vcd, "pex-imul-IntMulDivRTL_test_small_nn.vcd",
                    model, 0, 0, mul_test_msgs_small_nn )
...
def test_mul_large_pp( dump_vcd, test_verilog ):
  model = IntMulDivRTL()
  if test_verilog:
    model = get_verilated( model )
  run_imuldiv_test( dump_vcd, "pex-imul-IntMulDivRTL_test_large_pp.vcd",
                    model, 0, 0, mul_test_msgs_large_pp )
...
def test_mul_large_nn( dump_vcd, test_verilog ):
  model = IntMulDivRTL()
  if test_verilog:
    model = get_verilated( model )
  run_imuldiv_test( dump_vcd, "pex-imul-IntMulDivRTL_test_large_nn.vcd",
                    model, 0, 0, mul_test_msgs_large_nn )

#-----------------------------------------------------------------------
# mul unit test with delay = 10 x 5
#-----------------------------------------------------------------------

def test_mul_delay5x10( dump_vcd, test_verilog ):
  model = IntMulDivRTL()
  if test_verilog:
    model = get_verilated( model )
  run_imuldiv_test( dump_vcd, "pex-imul-IntMulDivRTL_test_delay5x10.vcd",
                    model, 5, 10, mul_test_msgs_small_pp )

#-----------------------------------------------------------------------
# mul unit test with delay = 10 x 5
#-----------------------------------------------------------------------

def test_mul_delay10x5( dump_vcd, test_verilog ):
  model = IntMulDivRTL()
  if test_verilog:
    model = get_verilated( model )
  run_imuldiv_test( dump_vcd, "pex-imul-IntMulDivRTL_test_delay10x5.vcd",
                    model, 10, 5, mul_test_msgs_small_pp )
...
def test_mul_random( dump_vcd, test_verilog ):
  model = IntMulDivRTL()
  if test_verilog:
    model = get_verilated( model )
  run_imuldiv_test( dump_vcd, "pex-imul-IntMulDivRTL_test_random.vcd",
                    model, 0, 0, mul_test_msgs_random )

def test_mul_random_delay5x10( dump_vcd, test_verilog ):
  model = IntMulDivRTL()
  if test_verilog:
    model = get_verilated( model )
  run_imuldiv_test( dump_vcd, "pex-imul-IntMulDivRTL_test_random_delay5x10.vcd",
                    model, 5, 10, mul_test_msgs_random )
...
def test_div_small_pp( dump_vcd, test_verilog ):
  model = IntMulDivRTL()
  if test_verilog:
    model = get_verilated( model )
  run_imuldiv_test( dump_vcd, "pex-idiv-IntMulDivRTL_test_small_pp.vcd",
...
def test_div_small_np( dump_vcd, test_verilog ):
  model = IntMulDivRTL()
  if test_verilog:
    model = get_verilated( model )
  run_imuldiv_test( dump_vcd, "pex-idiv-IntMulDivRTL_test_small_np.vcd",
...
def test_div_small_pn( dump_vcd, test_verilog ):
  model = IntMulDivRTL()
  if test_verilog:
    model = get_verilated( model )
  run_imuldiv_test( dump_vcd, "pex-idiv-IntMulDivRTL_test_small_pn.vcd",
...
def test_div_small_nn( dump_vcd, test_verilog ):
  model = IntMulDivRTL()
  if test_verilog:
    model = get_verilated( model )
  run_imuldiv_test( dump_vcd, "pex-idiv-IntMulDivRTL_test_small_nn.vcd",
...
def test_div_large_pp( dump_vcd, test_verilog ):
  model = IntMulDivRTL()
  if test_verilog:
    model = get_verilated( model )
  run_imuldiv_test( dump_vcd, "pex-idiv-IntMulDivRTL_test_large_pp.vcd",
...
def test_div_large_nn( dump_vcd, test_verilog ):
  model = IntMulDivRTL()
  if test_verilog:
    model = get_verilated( model )
  run_imuldiv_test( dump_vcd, "pex-idiv-IntMulDivRTL_test_large_nn.vcd",
...
def test_div_delay5x10( dump_vcd, test_verilog ):
  model = IntMulDivRTL()
  if test_verilog:
    model = get_verilated( model )
  run_imuldiv_test( dump_vcd, "pex-idiv-IntMulDivRTL_test_delay5x10.vcd",
                    model, 5, 10, div_test_msgs_small_pp )

#-----------------------------------------------------------------------
# div unit test with delay = 10 x 5
#-----------------------------------------------------------------------

def test_div_delay10x5( dump_vcd, test_verilog ):
  model = IntMulDivRTL()
  if test_verilog:
    model = get_verilated( model )
  run_imuldiv_test( dump_vcd, "pex-idiv-IntMulDivRTL_test_delay10x5.vcd",
                    model, 10, 5, div_test_msgs_small_pp )
...
def test_div_random( dump_vcd, test_verilog ):
  model = IntMulDivRTL()
  if test_verilog:
    model = get_verilated( model )
  run_imuldiv_test( dump_vcd, "pex-idiv-IntMulDivRTL_test_random.vcd",
                    model, 0, 0, div_test_msgs_random )

def test_div_random_delay5x10( dump_vcd, test_verilog ):
  model = IntMulDivRTL()
  if test_verilog:
    model = get_verilated( model )
  run_imuldiv_test( dump_vcd, "pex-idiv-IntMulDivRTL_test_random_delay5x10.vcd",
...
def test_remainder_small_pp( dump_vcd, test_verilog ):
  model = IntMulDivRTL()
  if test_verilog:
    model = get_verilated( model )
  run_imuldiv_test( dump_vcd, "pex-idiv-IntMulDivRTL_test_small_pp.vcd",
...
def test_remainder_small_nn( dump_vcd, test_verilog ):
  model = IntMulDivRTL()
  if test_verilog:
    model = get_verilated( model )
  run_imuldiv_test( dump_vcd, "pex-idiv-IntMulDivRTL_test_small_nn.vcd",
...
def test_remainder_small_np( dump_vcd, test_verilog ):
  model = IntMulDivRTL()
  if test_verilog:
    model = get_verilated( model )
  run_imuldiv_test( dump_vcd, "pex-idiv-IntMulDivRTL_test_small_np.vcd",
...
def test_remainder_small_pn( dump_vcd, test_verilog ):
  model = IntMulDivRTL()
  if test_verilog:
    model = get_verilated( model )
  run_imuldiv_test( dump_vcd, "pex-irem-IntMulDivRTL_test_small_pn.vcd",
...
def test_remainder_large_pp( dump_vcd, test_verilog ):
  model = IntMulDivRTL()
  if test_verilog:
    model = get_verilated( model )
  run_imuldiv_test( dump_vcd, "pex-irem-IntMulDivRTL_test_large_pp.vcd",
...
def test_remainder_large_nn( dump_vcd, test_verilog ):
  model = IntMulDivRTL()
  if test_verilog:
    model = get_verilated( model )
  run_imuldiv_test( dump_vcd, "pex-irem-IntMulDivRTL_test_large_nn.vcd",
...
def test_remainder_delay5x10( dump_vcd, test_verilog ):
  model = IntMulDivRTL()
  if test_verilog:
    model = get_verilated( model )
  run_imuldiv_test( dump_vcd, "pex-irem-IntMulDivRTL_test_delay5x10.vcd",
...
def test_remainder_delay10x5( dump_vcd, test_verilog ):
  model = IntMulDivRTL()
  if test_verilog:
    model = get_verilated( model )
  run_imuldiv_test( dump_vcd, "pex-irem-IntMulDivRTL_test_delay10x5.vcd",
...
def test_remainder_random( dump_vcd, test_verilog ):
  model = IntMulDivRTL()
  if test_verilog:
    model = get_verilated( model )
  run_imuldiv_test( dump_vcd, "pex-irem-IntMulDivRTL_test_random.vcd",
                    model, 0, 0, rem_test_msgs_random )

def test_remainder_random_delay5x10( dump_vcd, test_verilog ):
  model = IntMulDivRTL()
  if test_verilog:
    model = get_verilated( model )
  run_imuldiv_test( dump_vcd, "pex-irem-IntMulDivRTL_test_random_delay5x10.vcd",
...
def test_muldivrem_combined( dump_vcd, test_verilog ):
  model = IntMulDivRTL()
  if test_verilog:
    model = get_verilated( model )
  run_imuldiv_test( dump_vcd, "pex-irem-IntMulDivRTL_test_combined.vcd",
                    model, 0, 0, test_muldivrem_msgs_combined )
...
def test_div_legacy( dump_vcd, test_verilog ):
  model = IntMulDivRTL()
  if test_verilog:
    model = get_verilated( model )
...
def test_rem_legacy( dump_vcd, test_verilog ):
  model = IntMulDivRTL()
  if test_verilog:
    model = get_verilated( model )
...
def test_divu_legacy( dump_vcd, test_verilog ):
  model = IntMulDivRTL()
  if test_verilog:
    model = get_verilated( model )
...
def test_remu_legacy( dump_vcd, test_verilog ):
  model = IntMulDivRTL()
  if test_verilog:
    model = get_verilated( model )
