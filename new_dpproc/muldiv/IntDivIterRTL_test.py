...
def test_small_pp( dump_vcd, test_verilog ):
  ...
  run_idivrem_test( dump_vcd, "pex-idiv-IntDivIterRTL_test_small_pp.vcd",
...
def test_small_np( dump_vcd, test_verilog ):
  ...
  if test_verilog:
    model = get_verilated( model )
  run_idivrem_test( dump_vcd, "pex-idiv-IntDivIterRTL_test_small_np.vcd",
...
def test_small_pn( dump_vcd, test_verilog ):
  ...
  if test_verilog:
    model = get_verilated( model )
  run_idivrem_test( dump_vcd, "pex-idiv-IntDivIterRTL_test_small_pn.vcd",
...
def test_small_nn( dump_vcd, test_verilog ):
  ...
  if test_verilog:
    model = get_verilated( model )
  run_idivrem_test( dump_vcd, "pex-idiv-IntDivIterRTL_test_small_nn.vcd",
...
def test_large_pp( dump_vcd, test_verilog ):
  ...
  if test_verilog:
    model = get_verilated( model )
  run_idivrem_test( dump_vcd, "pex-idiv-IntDivIterRTL_test_large_pp.vcd",
...
def test_large_nn( dump_vcd, test_verilog ):
  ...
  if test_verilog:
    model = get_verilated( model )
  run_idivrem_test( dump_vcd, "pex-idiv-IntDivIterRTL_test_large_nn.vcd",
...
def test_delay5x10( dump_vcd, test_verilog ):
  ...
  if test_verilog:
    model = get_verilated( model )
  run_idivrem_test( dump_vcd, "pex-idiv-IntDivIterRTL_test_delay5x10.vcd",
...
def test_delay10x5( dump_vcd, test_verilog ):
  ...
  if test_verilog:
    model = get_verilated( model )
  run_idivrem_test( dump_vcd, "pex-idiv-IntDivIterRTL_test_delay10x5.vcd",
...
def test_random( dump_vcd, test_verilog ):
  ...
  if test_verilog:
    model = get_verilated( model )
  run_idivrem_test( dump_vcd, "pex-idiv-IntDivIterRTL_test_random.vcd",
...
def test_random_delay5x10( dump_vcd, test_verilog ):
  ...
  if test_verilog:
    model = get_verilated( model )
  run_idivrem_test( dump_vcd, "pex-idiv-IntDivIterRTL_test_random_delay5x10.vcd",
                    model, 5, 10, div_test_msgs_random )

def test_random_delay10x5( dump_vcd, test_verilog ):
  model = IntDivIterRTL()
  if test_verilog:
    model = get_verilated( model )
  run_idivrem_test( dump_vcd, "pex-idiv-IntDivIterRTL_test_random_delay10x5.vcd",
...
def test_remainder_large_pp( dump_vcd, test_verilog ):
  ...
  if test_verilog:
    model = get_verilated( model )
  run_idivrem_test( dump_vcd, "pex-irem-IntDivIterRTL_test_large_pp.vcd",
...
def test_remainder_large_nn( dump_vcd, test_verilog ):
  ...
  if test_verilog:
    model = get_verilated( model )
  run_idivrem_test( dump_vcd, "pex-irem-IntDivIterRTL_test_large_nn.vcd",
